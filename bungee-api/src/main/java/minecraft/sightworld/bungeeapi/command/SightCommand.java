...
import minecraft.sightworld.defaultlib.utils.Cooldown;
...
public abstract class SightCommand extends Command implements TabExecutor { // Команда для модулей, где надо регать вручную все
    ...
    public SightCommand(final String name, final String... aliases) {
