...
import minecraft.sightworld.bukkitapi.packet.scoreboard.WrapperPlayServerScoreboardDisplayObjective;
import minecraft.sightworld.bukkitapi.packet.scoreboard.WrapperPlayServerScoreboardObjective;
import minecraft.sightworld.bukkitapi.util.MetadataUtil;
...
public class BaseScoreboard {
    ...
    public void addScoreboardUpdater(@NonNull ScoreboardUpdater scoreboardUpdater,
        ...
        }.runTaskTimer(SightWorld.getInstance(), durationTick, durationTick);
